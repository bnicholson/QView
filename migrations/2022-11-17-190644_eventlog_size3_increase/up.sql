...
create table eventlogs (
    ...
    organization VARCHAR(48) NOT NULL,                              -- organization? Nazarene? World Bible?
    bldgroom VARCHAR(32) NOT NULL,                                  -- what building/room
    tournament VARCHAR(48) NOT NULL,                                -- tournament
    division VARCHAR(48) NOT NULL,                                  -- division
    room VARCHAR(48) NOT NULL,                                      -- room
    round varchar(48) NOT NULL,                                     -- round
    question INTEGER NOT NULL,                                      -- question
    eventnum INTEGER NOT NULL,                                      -- event number
    name VARCHAR(64) NOT NULL,                                      -- name of the quizzer or team
    team INTEGER NOT NULL,                                          -- team # (0-2)
    quizzer INTEGER NOT NULL,                                       -- quizzer (0-4)
    event VARCHAR(2) NOT NULL,                                      -- event (TC, BE, ...)
    parm1 VARCHAR(64) NOT NULL,                                     -- parameter used by a specific event
    parm2 VARCHAR(64) NOT NULL,                                     -- another one

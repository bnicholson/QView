...
create table tournaments (
    id BIGSERIAL UNIQUE PRIMARY KEY,                       -- unique id of this tournament
    organization varchar(32) NOT NULL,
    tournament varchar(32) NOT NULL,                              -- name of the tournament (human readable)
...
INSERT INTO tournaments (id, organization,tournament, fromdate, todate, venue, city, region, country,
    contact, contactemail, hide, shortinfo, info, created_at, updated_at)    
    SELECT tid, organization,tname,fromdate,todate,venue,city,region,country,
        contact,contactemail, hide, shortinfo, info, created_at, updated_at from orig_tournaments;

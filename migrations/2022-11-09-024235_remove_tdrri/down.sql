...
INSERT INTO games (tdrri, org, tournament, division, room, round, clientkey, ignore, ruleset) 
...
-- Now copy the old table into the new table
INSERT INTO quizevents (tdrri, question, eventnum, name, team, quizzer, event, parm1, parm2, clientts, serverts, md5digest) 
    SELECT gid, question, eventnum, name, team, quizzer, event, parm1, parm2, clientts, serverts, md5digest from orig_quizevents;
